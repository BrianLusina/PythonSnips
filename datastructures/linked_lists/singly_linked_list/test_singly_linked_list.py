...
class SingleLinkedListReverseKGroupsTestCases(unittest.TestCase):
    def test_reverse_groups_of_4_of_non_empty_list(self):
        ...
        new_head = linked_list.reverse_groups(4)
    ...
    def test_reverse_groups_of_2_of_non_empty_list_1_2_3_4_5(self):
        linked_list = SinglyLinkedList()
        linked_list.append(1)
        linked_list.append(2)
        linked_list.append(3)
        ...
        new_head = linked_list.reverse_groups(2)

        self.assertIsNotNone(new_head)
        self.assertEqual(2, new_head.data)

    def test_reverse_groups_of_3_of_non_empty_list_1_2_3_4_5(self):
        # 1 -> 2 -> 3 -> 4 -> 5
        # 3 -> 2 -> 1 -> 4 -> 5
        linked_list = SinglyLinkedList()
        linked_list.append(1)
    ...
    def test_reverse_groups_of_2_of_non_empty_list_1_2_3_4_5_6(self):
        """should reverse a linked list of 1 -> 2 -> 3 -> 4 -> 5 -> 6 in groups of k = 2"""
        linked_list = SinglyLinkedList()
        linked_list.append(1)
        linked_list.append(2)
        linked_list.append(3)
    ...
    def test_reverse_groups_of_1_of_non_empty_list_8_11_4_12_0(self):
        """should reverse a linked list of 8 -> 11 -> 4 -> 12 -> 0 in groups of k = 1"""
        linked_list = SinglyLinkedList()
        linked_list.append(8)
        ...
        new_head = linked_list.reverse_groups(1)

        self.assertIsNotNone(new_head)
        self.assertEqual(8, new_head.data)
