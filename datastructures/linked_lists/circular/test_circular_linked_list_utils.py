...
from datastructures.linked_lists.circular.circular_linked_list_utils import (
...
class CircularLinkedListUtilsTestCase(unittest.TestCase):
    ...
    def test_split_list(self, data: List[int], expected: Tuple[List[int], List[int]]):
        ...
        result = split_circular_linked_list(circular_linked_list.head)
