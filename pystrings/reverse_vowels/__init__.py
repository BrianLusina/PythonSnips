def reverse_vowels(word: str) -> str:
    ...
    while left_pointer < right_pointer:
        ...
        characters[left_pointer], characters[right_pointer] = characters[right_pointer], characters[left_pointer]
...
def is_vowel(letter: str) -> bool:
    vowels = {"a": True, "A": True, "e": True, "E": True, "i": True, "I": True, "o": True, "O": True, "u": True,
              "U": True}
