...
def largest_product_in_grid(grid: list):
    ...
    for x in range(20):
        for y in range(17):
            horizontal_product = grid[x][y] * grid[x][y + 1] * grid[x][y + 2] * grid[x][y + 3]
            vertical_product = grid[y][x] * grid[y + 1][x] * grid[y + 2][x] * grid[y + 3][x]
    ...
    for a in range(17):
        for b in range(17):
            diag_left_product = grid[a][b] * grid[a + 1][b + 1] * grid[a + 2][b + 2] * grid[a + 3][b + 3]
            diag_right_product = grid[a][b + 3] * grid[a + 1][b + 2] * grid[a + 2][b + 1] * grid[a + 3][b]
