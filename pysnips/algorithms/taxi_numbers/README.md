# Taxi Cab Numbers
A [taxicab number](https://en.wikipedia.org/wiki/1729_(number)) (the definition that is being used here) is a positive integer that can be expressed as the sum of two positive cubes in more than one way.
