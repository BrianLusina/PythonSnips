...
## Datascience
  ...
  * Numeric Python
    ...
    * Two Dimension
      ...
      * [Two Dimension](https://github.com/BrianLusina/PythonSnips/blob/master/datascience/numeric_python/two_dimension/two_dimension.py)
  * Wine Data
...
## Pymath
  ...
  * Triangles
    * Angle Mbc
      * [Angle Mbc](https://github.com/BrianLusina/PythonSnips/blob/master/pymath/triangles/angle_mbc/angle_mbc.py)
  * Vampire Numbers
...
## Tests
  * Algorithms
    ...
    * [Test Rna To Protein](https://github.com/BrianLusina/PythonSnips/blob/master/tests/algorithms/test_rna_to_protein.py)
  ...
  * Cryptography
    ...
    * [Test Isbn Verifier](https://github.com/BrianLusina/PythonSnips/blob/master/tests/cryptography/test_isbn_verifier.py)
  ...
  * Datastructures
    * [Test 2D Array](https://github.com/BrianLusina/PythonSnips/blob/master/tests/datastructures/test_2d_array.py)
    * [Test Array Chunks](https://github.com/BrianLusina/PythonSnips/blob/master/tests/datastructures/test_array_chunks.py)
    * [Test Array Diff](https://github.com/BrianLusina/PythonSnips/blob/master/tests/datastructures/test_array_diff.py)
    * [Test Array Pair Sum](https://github.com/BrianLusina/PythonSnips/blob/master/tests/datastructures/test_array_pair_sum.py)
    * [Test Bin Arr To Num](https://github.com/BrianLusina/PythonSnips/blob/master/tests/datastructures/test_bin_arr_to_num.py)
    * [Test Binary Search](https://github.com/BrianLusina/PythonSnips/blob/master/tests/datastructures/test_binary_search.py)
    * [Test Bracket Validator](https://github.com/BrianLusina/PythonSnips/blob/master/tests/datastructures/test_bracket_validator.py)
    * [Test Build One 2 3](https://github.com/BrianLusina/PythonSnips/blob/master/tests/datastructures/test_build_one_2_3.py)
    * [Test Build Tower](https://github.com/BrianLusina/PythonSnips/blob/master/tests/datastructures/test_build_tower.py)
    ...
    * [Test Dot Dsl](https://github.com/BrianLusina/PythonSnips/blob/master/tests/datastructures/test_dot_dsl.py)
    ...
    * [Test Doubly Linked List](https://github.com/BrianLusina/PythonSnips/blob/master/tests/datastructures/test_doubly_linked_list.py)
    ...
    * [Test Product](https://github.com/BrianLusina/PythonSnips/blob/master/tests/datastructures/test_product.py)
    ...
    * [Test Singly Linked List](https://github.com/BrianLusina/PythonSnips/blob/master/tests/datastructures/test_singly_linked_list.py)
  ...
  * Pymath
    ...
    * [Test Largest Palindrome Product](https://github.com/BrianLusina/PythonSnips/blob/master/tests/pymath/test_largest_palindrome_product.py)
  ...
  * Pyregex
    ...
    * [Test Autocorrect](https://github.com/BrianLusina/PythonSnips/blob/master/tests/pyregex/test_autocorrect.py)
  ...
  * Pystrings
    ...
    * [Test Anagram](https://github.com/BrianLusina/PythonSnips/blob/master/tests/pystrings/test_anagram.py)
    ...
    * [Test Common Ground](https://github.com/BrianLusina/PythonSnips/blob/master/tests/pystrings/test_common_ground.py)
    * [Test Compress](https://github.com/BrianLusina/PythonSnips/blob/master/tests/pystrings/test_compress.py)
    * [Test Consecutive String](https://github.com/BrianLusina/PythonSnips/blob/master/tests/pystrings/test_consecutive_string.py)
    * [Test Contain All Rots](https://github.com/BrianLusina/PythonSnips/blob/master/tests/pystrings/test_contain_all_rots.py)
    * [Test Denumerate](https://github.com/BrianLusina/PythonSnips/blob/master/tests/pystrings/test_denumerate.py)
    ...
    * [Test Palindrome](https://github.com/BrianLusina/PythonSnips/blob/master/tests/pystrings/test_palindrome.py)
    * [Test Palindrome Pairs](https://github.com/BrianLusina/PythonSnips/blob/master/tests/pystrings/test_palindrome_pairs.py)
    * [Test Pangram](https://github.com/BrianLusina/PythonSnips/blob/master/tests/pystrings/test_pangram.py)
    * [Test Pattern](https://github.com/BrianLusina/PythonSnips/blob/master/tests/pystrings/test_pattern.py)
    * [Test Play Two Strings](https://github.com/BrianLusina/PythonSnips/blob/master/tests/pystrings/test_play_two_strings.py)
    * [Test Rake Garden](https://github.com/BrianLusina/PythonSnips/blob/master/tests/pystrings/test_rake_garden.py)
    * [Test Random Caser](https://github.com/BrianLusina/PythonSnips/blob/master/tests/pystrings/test_random_caser.py)
    ...
    * [Test Swappie](https://github.com/BrianLusina/PythonSnips/blob/master/tests/pystrings/test_swappie.py)
    * [Test Tail Swap](https://github.com/BrianLusina/PythonSnips/blob/master/tests/pystrings/test_tail_swap.py)
    * [Test Title Case](https://github.com/BrianLusina/PythonSnips/blob/master/tests/pystrings/test_title_case.py)
    * [Test Tower Builder](https://github.com/BrianLusina/PythonSnips/blob/master/tests/pystrings/test_tower_builder.py)
    * [Test Truncate](https://github.com/BrianLusina/PythonSnips/blob/master/tests/pystrings/test_truncate.py)
    * [Test Twelve Days](https://github.com/BrianLusina/PythonSnips/blob/master/tests/pystrings/test_twelve_days.py)
    * [Test Two Fer](https://github.com/BrianLusina/PythonSnips/blob/master/tests/pystrings/test_two_fer.py)
    * [Test Uni Total](https://github.com/BrianLusina/PythonSnips/blob/master/tests/pystrings/test_uni_total.py)
    * [Test Word Search](https://github.com/BrianLusina/PythonSnips/blob/master/tests/pystrings/test_word_search.py)
    * [Test Wrong End](https://github.com/BrianLusina/PythonSnips/blob/master/tests/pystrings/test_wrong_end.py)
    * [Test Xoxo](https://github.com/BrianLusina/PythonSnips/blob/master/tests/pystrings/test_xoxo.py)
  * Pytime
    * [Test Clock](https://github.com/BrianLusina/PythonSnips/blob/master/tests/pytime/test_clock.py)
    * [Test Clock In Mirror](https://github.com/BrianLusina/PythonSnips/blob/master/tests/pytime/test_clock_in_mirror.py)
