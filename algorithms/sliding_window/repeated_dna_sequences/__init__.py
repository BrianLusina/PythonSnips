...
def find_repeated_dna_sequences(dna_sequence: str) -> List[str]:
    ...
    dna_sequence_substr_length, dna_sequence_length = (
        10,
        len(dna_sequence),
    )  # Length of DNA sequence to check
    ...
    for start in range(1, dna_sequence_length - dna_sequence_substr_length + 1):
        ...
        rolling_hash_value = (
            ...
            - encoded_sequence[start - 1] * a_k
            + encoded_sequence[start + dna_sequence_substr_length - 1]
        )
