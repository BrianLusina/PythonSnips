...
from generators_and_iterators.iterators.recur_iter import (
    replicate_iter,
    replicate_recur,
)
...
class ReplicateIterTestCases(unittest.TestCase):
    def test_it_returns_a_list_of_replicated_numbers(self):
        ...
        self.assertEqual(
            result,
            [5, 5, 5],
            msg="It should produce a list of three fives for the input 3, 5",
        )
    ...
    def test_it_returns_an_empty_list_for_negative_times(self):
        ...
        self.assertEqual(
            result, [], msg="It should return an empty list for negative times."
        )
    ...
    def test_it_can_repeat_strings(self):
        ...
        self.assertEqual(
            result, ["str", "str", "str"], msg="Should replicate strings too"
        )
...
class ReplicateRecurTestCases(unittest.TestCase):
    def test_it_returns_a_list_of_replicated_numbers(self):
        ...
        self.assertEqual(
            result,
            [5, 5, 5, 5],
            msg="It should produce a list of four fives for the input 4, 5",
        )
