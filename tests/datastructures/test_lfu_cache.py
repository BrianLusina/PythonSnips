...
class LFUCacheTestCases(unittest.TestCase):
    def test_with_capacity_of_2(self):
        ...
        lfucache.put(1, 1)
        self.assertEqual(1, lfucache._current_size)

        lfucache.put(2, 2)
        self.assertEqual(2, lfucache._current_size)

        value_one = lfucache.get(1)
        self.assertEqual(1, value_one)
        ...
        self.assertEqual(3, value_3_two)

        value_4 = lfucache.get(4)
        self.assertEqual(4, value_4)
