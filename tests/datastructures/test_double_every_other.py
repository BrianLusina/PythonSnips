...
class DoubleTests(unittest.TestCase):
    ...
    def test_two(self):
        self.assertEqual(
            [1, 38, 6, 4, 12, -6], double_every_other([1, 19, 6, 2, 12, -3])
        )

    def test_three(self):
        self.assertEqual(
            [-1000, 3306, 210, 0, 1], double_every_other([-1000, 1653, 210, 0, 1])
        )

    def test_4(self):
        self.assertEqual(
            [-1278, 2276, 1617, 9076, -73, 7188, -1571, 2392, -46, 9856],
            double_every_other(
                [-1278, 1138, 1617, 4538, -73, 3594, -1571, 1196, -46, 4928]
            ),
        )
    ...
    def test_6(self):
        self.assertEqual(
            [1802, 6272, -148, -10812, 700, 6272, -484],
