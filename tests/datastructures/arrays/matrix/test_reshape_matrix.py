...
from datastructures.arrays.matrix.reshape_matrix import matrix_reshape, matrix_reshape_2, matrix_reshape_3
...
class ReshapeMatrixTestCases(unittest.TestCase):
    ...
    def test_should_return_original_matrix_if_reshape_can_not_happen_for_r_2_and_c_4(self):
    ...
    def test_should_return_original_matrix_if_reshape_can_not_happen_for_r_2_and_c_4_with_matrix_reshape_2(self):
    ...
    def test_should_return_original_matrix_if_reshape_can_not_happen_for_r_2_and_c_4_with_matrix_reshape_3(self):
