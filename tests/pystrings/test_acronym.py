...
class AcronymTestCase(unittest.TestCase):
    ...
    def test_4(self):
        self.assertEqual(
            ...
            "SMB is an acronym. I do not like "
    ...
    def test_9(self):
        self.assertEqual(
            acronym_buster("TBD by EOD"), "To be decided by the end of the day"
        )

    def test_10(self):
        self.assertEqual(
            acronym_buster("BRB I am OOO"),
            "BRB is an acronym. I do not like acronyms. Please remove "
    ...
    def test_15(self):
        self.assertEqual(
            acronym_buster("Hi PAB"),
            "PAB is an acronym. I do not like acronyms. Please remove them "
            "from your email.",
        )

    def test_16(self):
        self.assertEqual(
            acronym_buster("HATDBEA"),
            "HATDBEA is an acronym. I do not like acronyms. Please remove "
            "them from your email.",
        )
    ...
    def test_17(self):
        self.assertEqual(
            acronym_buster("LDS"),
            "LDS is an acronym. I do not like acronyms. Please remove them from "
            "your email.",
        )
    ...
    def test_20(self):
        self.assertEqual(
            acronym_buster("CTA and HTTP"),
            "HTTP is an acronym. I do not like acronyms. Please remove "
            "them from your email.",
        )

    def test_21(self):
        self.assertEqual(
            acronym_buster("SWOT."), "Strengths, weaknesses, opportunities and threats."
        )
    ...
    def test_26(self):
        self.assertEqual(
            acronym_buster("My SM account needs some work."),
