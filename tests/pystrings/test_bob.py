...
class BobTests(unittest.TestCase):
    ...
    def test_asking_a_question(self):
        self.assertEqual("Sure.", hey("Does this cryogenic chamber make me look fat?"))

    def test_asking_a_numeric_question(self):
        self.assertEqual("Sure.", hey("You are, what, like 15?"))

    def test_talking_forcefully(self):
        self.assertEqual("Whatever.", hey("Let's go make out behind the gym!"))
    ...
    def test_forceful_questions(self):
        self.assertEqual("Whoa, chill out!", hey("WHAT THE HELL WERE YOU THINKING?"))
    ...
    def test_shouting_with_special_characters(self):
        self.assertEqual(
            "Whoa, chill out!", hey("ZOMG THE %^*@#$(*^ ZOMBIES ARE COMING!!11!!1!")
        )

    def test_shouting_with_umlauts(self):
        self.assertEqual("Whoa, chill out!", hey("ÜMLÄÜTS!"))

    def test_calmly_speaking_with_umlauts(self):
        self.assertEqual("Whatever.", hey("ÜMLäÜTS!"))

    def test_shouting_with_no_exclamation_mark(self):
        self.assertEqual("Whoa, chill out!", hey("I HATE YOU"))

    def test_statement_containing_question_mark(self):
        self.assertEqual("Whatever.", hey("Ending with ? means a question."))

    def test_prattling_on(self):
        self.assertEqual("Sure.", hey("Wait! Hang on. Are you going to be OK?"))
    ...
    def test_ends_with_whitespace(self):
        self.assertEqual("Sure.", hey("What if we end with whitespace?   "))
