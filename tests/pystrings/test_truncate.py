...
class MyTestCase(unittest.TestCase):
    ...
    def test_4(self):
        self.assertEqual(
            truncate_string("A-tisket a-tasket A green and yellow basket", 43),
            "A-tisket a-tasket A green and yellow basket",
        )

    def test_5(self):
        self.assertEqual(
            truncate_string("A-tisket a-tasket A green and yellow basket", 45),
            "A-tisket a-tasket A green and yellow basket",
        )
    ...
    def test_8(self):
        self.assertEqual(
            truncate_string("Chingel loves his Angel so much!!!", 27),
            "Chingel loves his Angel ...",
        )

    def test_9(self):
        self.assertEqual(
            truncate_string("I like ice-cream.Do you?", 19), "I like ice-cream..."
        )
