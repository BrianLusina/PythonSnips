...
from pysnips.math_pysnips.pythagorean_triplet import (primitive_triplets, triplets_in_range,
...
class PythagoreanTripletTest(unittest.TestCase):
    ...
    def test_range2(self):
        ans = {(57, 76, 95), (60, 63, 87)}
        self.assertEqual(ans, triplets_in_range(56, 95))

    def test_is_triplet1(self):
        self.assertEqual(True, is_pythagorean_triplet((29, 20, 21)))

    def test_is_triplet2(self):
        self.assertEqual(False, is_pythagorean_triplet((25, 25, 1225)))

    def test_is_triplet3(self):
        self.assertEqual(True, is_pythagorean_triplet((924, 43, 925)))
