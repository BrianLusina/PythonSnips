...
class GigasecondTest(unittest.TestCase):
    def test_1(self):
        ...
        self.assertEqual(datetime(2043, 1, 1, 1, 46, 40), gigasecond.add_gigasecond())

    def test_2(self):
        gigasecond = Gigasecond(datetime(1977, 6, 13))
        self.assertEqual(datetime(2009, 2, 19, 1, 46, 40), gigasecond.add_gigasecond())

    def test_3(self):
        gigasecond = Gigasecond(datetime(1959, 7, 19))
        self.assertEqual(datetime(1991, 3, 27, 1, 46, 40), gigasecond.add_gigasecond())

    def test_4(self):
        gigasecond = Gigasecond(datetime(2015, 1, 24, 22, 0, 0))
        self.assertEqual(datetime(2046, 10, 2, 23, 46, 40), gigasecond.add_gigasecond())

    def test_5(self):
        gigasecond = Gigasecond(datetime(2015, 1, 24, 23, 59, 59))
        self.assertEqual(datetime(2046, 10, 3, 1, 46, 39), gigasecond.add_gigasecond())
    ...
    def test_yourself(self):
        ...
        self.assertEqual(your_gigasecond, gigasecond.add_gigasecond())
