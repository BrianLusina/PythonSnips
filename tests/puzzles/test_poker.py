...
class PokerTest(unittest.TestCase):
    ...
    def test_two_double_pair(self):
        ...
        self.assertEqual(
            [double_pair2and8], poker([double_pair2and8, double_pair4and5])
        )
    ...
    def test_square_vs_straight_flush(self):
        ...
        self.assertEqual([straight_flush_to9], poker([square_of5, straight_flush_to9]))

    def test_two_straight_flushes(self):
        straight_flush_to8 = "4H 6H 7H 8H 5H".split()
        straight_flush_to9 = "5S 7S 8S 9S 6S".split()
        self.assertEqual(
            [straight_flush_to9], poker([straight_flush_to8, straight_flush_to9])
        )
    ...
    def test_three_hand_with_tie(self):
        ...
        self.assertEqual(
            [spade_straight_to9, diamond_straight_to9],
