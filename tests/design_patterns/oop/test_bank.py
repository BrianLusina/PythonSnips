...
from design_patterns.oop.banker import BankAccount, current_account, savings_account
...
class CurrentAccountTestCases(unittest.TestCase):
    ...
    def test_current_account_handles_invalid_inputs(self):
        ...
        self.assertEqual(
            message, "Invalid deposit amount", msg="Can not add a string to a a number"
        )
