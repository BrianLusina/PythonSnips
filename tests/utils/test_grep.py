...
class GrepTest(unittest.TestCase):
    ...
    def test_one_file_one_match_no_flags(self):
        self.assertMultiLineEqual(
            grep("Agamemnon", [ILIADFILENAME]), "Of Atreus, Agamemnon, King of men.\n"
        )
    ...
    def test_one_file_one_match_print_file_names_flag(self):
        self.assertMultiLineEqual(
            grep("Forbidden", [PARADISELOSTFILENAME], "-l"), PARADISELOSTFILENAME + "\n"
        )

    def test_one_file_one_match_match_entire_lines_flag(self):
        self.assertMultiLineEqual(
            grep(
                "With loss of Eden, till one greater Man", [PARADISELOSTFILENAME], "-x"
            ),
            "With loss of Eden, till one greater Man\n",
        )
    ...
    def test_one_file_several_matches_match_entire_lines_flag(self):
        self.assertMultiLineEqual(grep("may", [MIDSUMMERNIGHTFILENAME], "-x"), "")
    ...
    def test_one_file_no_matches_various_flags(self):
        self.assertMultiLineEqual(grep("Gandalf", [ILIADFILENAME], "-n -l -x -i"), "")
    ...
    def test_multiple_files_several_matches_print_line_numbers_flag(self):
        self.assertMultiLineEqual(
            grep(
                "that", ["iliad.txt", "midsummer-night.txt", "paradise-lost.txt"], "-n"
            ),
            (
    ...
    def test_multiple_files_one_match_print_file_names_flag(self):
        self.assertMultiLineEqual(
            grep(
                "who", ["iliad.txt", "midsummer-night.txt", "paradise-lost.txt"], "-l"
            ),
