import unittest
from pysnips.py_strings_words.rake_garden import rake_garden


class RakeGardenTests(unittest.TestCase):
    def test_1(self):
        garden1 = 'slug spider rock gravel gravel gravel gravel gravel gravel gravel'
        self.assertEqual(rake_garden(garden1),'gravel gravel rock gravel gravel gravel gravel gravel gravel gravel' )
