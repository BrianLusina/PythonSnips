...
class CaeserCipherTests(unittest.TestCase):
    ...
    def test_rotate_numbers(self):
        ...
        self.assertEqual(
            caeser.encrypt("Testing 1 2 3 testing"), "Xiwxmrk 1 2 3 xiwxmrk"
        )
    ...
    def test_rotate_numbers_on_caeser_v2(self):
        ...
        self.assertEqual(
            caeser.encode("Testing 1 2 3 testing"), "Xiwxmrk 1 2 3 xiwxmrk".upper()
        )

    def test_rotate_punctuation_on_caeser_v2(self):
        caeser = CaesarCipherV2(21)
        self.assertEqual(
            caeser.encode("Let's eat, Grandma!"), "Gzo'n zvo, Bmviyhv!".upper()
        )

    def test_rotate_all_letters_on_caeser_v2(self):
        caeser = CaesarCipherV2(13)
        self.assertEqual(
            caeser.encode("The quick brown fox jumps" " over the lazy dog."),
