...
(119, "pepper"),(114, "carrot"),(113, "turnip"),(102, "onion"),(101, "tofu"),(100, "cabbage"),(93, "mushroom"),(90, "cucumber"),(88, "potato"),(80, "celery")
"""
from collections import Counter
...
s = "potato potato tofu kales kales tomatoes celery cucumber cucumber cucumber"
sl = s.split()
print [(x, sl.count(x)) for x in sl]

count = dict(Counter(s.split()))
print list(count.iteritems())
res = [i for i in count.iteritems()]
print line

lst = [(2,"potato"),(1,'tofu'),(2,'kales'),(1,'tomatoes'),(1,'celery'),(3,'cucumber')]
print Test.test_function(count_vegetables("potato potato tofu kales kales tomatoes celery cucumber cucumber cucumber"),lst)
...
print Test.test_function(count_vegetables(s1), (lst1))
...
print Test.test_function(count_vegetables(s2), (lst2))
print line
